...
| **DataRelay Grant** | US 12,056,667 B1 및 KR 10-2567118 B1 기반의 Coming Soon Human Approval / Execution Control Layer | [grant.datarelay.run](https://grant.datarelay.run/) |

## 공통 Engineering Foundation

<Card title="Data Relay Engineering System" icon="code-branch" href="https://engineering.datarelay.run/ko">
  각 제품 Runtime은 독립적으로 유지하면서, Engineering System이 설계, 구현 Handoff, deterministic test, PR/CI 검증, Release Evidence, 운영, Session Continuity의 공통 Lifecycle을 제공합니다. 사람용 Handbook은 engineering.datarelay.run에서 제공하고 canonical 표준은 [datarelay-labs/engineering-system](https://github.com/datarelay-labs/engineering-system)에 있습니다.
</Card>

Engineering System은 **별도의 제품 Runtime이 아니며**, Link, Control, Grant 사이에 Runtime 의존성을 만들지 않습니다.
